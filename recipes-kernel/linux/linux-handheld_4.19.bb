...
SRC_URI = "${KERNELORG_MIRROR}/linux/kernel/v4.x/linux-${PV}.tar.xz;name=kernel \
           ${KERNELORG_MIRROR}/linux/kernel/v4.x/patch-${PV}.94.xz;apply=yes;name=stablepatch \
           "
...
SRC_URI[stablepatch.md5sum] = "eef7ee148f6288a71b2748047446e63f"
SRC_URI[stablepatch.sha256sum] = "8392d2cb5aa1ff2b1179d25acfcdd3b7b4770e19248dba98b50cf12db8ccdf81"
